...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex-1 flex items-center justify-center ui-bg-base p-4">
          <div className="text-center max-w-sm">
            <div className="text-2xl mb-2 opacity-40">⚠</div>
            <h3 className="text-sm font-medium ui-text mb-1">
              {this.props.fallbackLabel ?? 'Component'} failed to load
            </h3>
            <p className="text-xs ui-text-faint mb-3">
